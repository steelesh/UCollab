    ...
    <div className="flex flex-col items-center">
      ...
      <div className="relative mt-8 flex w-full justify-center">
        <div
          ...
          <p className="mt-2 text-sm">
            <strong>Skills:</strong> {teamMembers[activeIndex]?.skills}
          </p>
          <p className="mt-2 text-sm">
            <strong>Contributions:</strong> {teamMembers[activeIndex]?.contributions}
          </p>
          <a
      ...
      <div className="mt-8 w-full max-w-3xl rounded-lg shadow-2xl" style={{ maxWidth: 'calc(50vw' }}>
        ...
        <ul className="text-secondary-foreground mt-4 list-disc space-y-2 pl-5">
          <ul>
            <strong>♦️ Collaboration:</strong> We thrive in teamwork, ensuring that every contribution is valued.
          </ul>
          <ul>
            <strong>♦️ Innovation:</strong> We embrace creativity and forward-thinking solutions.
          </ul>
          <ul>
            <strong>♦️ Growth:</strong> Learning never stops, and we are committed to continuous development.
          </ul>
          <ul>
            <strong>♦️ Open-Source Culture:</strong> Transparency and inclusivity define our approach to building
            technology.
          </ul>
        </ul>
      </div>
