  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        developer_available: "relative overflow-hidden bg-gradient-to-br from-gray-400/10 to-gray-500/5 text-gray-500 border border-gray-400/30 shadow-sm backdrop-blur-sm before:absolute before:inset-0 before:bg-gradient-to-b before:from-foreground/[0.02] before:to-transparent after:absolute after:inset-0 after:bg-gradient-to-t after:from-background/10 after:to-transparent transition-all duration-300 ease-in-out group-hover:shadow-md group-hover:border-gray-400/50 dark:shadow dark:group-hover:shadow-lg",
        seeking_mentor: "relative overflow-hidden bg-gradient-to-br from-amber-400/10 to-amber-500/5 text-amber-500 border border-amber-400/30 shadow-sm backdrop-blur-sm before:absolute before:inset-0 before:bg-gradient-to-b before:from-foreground/[0.02] before:to-transparent after:absolute after:inset-0 after:bg-gradient-to-t after:from-background/10 after:to-transparent transition-all duration-300 ease-in-out group-hover:shadow-md group-hover:border-amber-400/50 dark:shadow dark:group-hover:shadow-lg",
        mentor_available: "relative overflow-hidden bg-gradient-to-br from-emerald-400/10 to-emerald-500/5 text-emerald-500 border border-emerald-400/30 shadow-sm backdrop-blur-sm before:absolute before:inset-0 before:bg-gradient-to-b before:from-foreground/[0.02] before:to-transparent after:absolute after:inset-0 after:bg-gradient-to-t after:from-background/10 after:to-transparent transition-all duration-300 ease-in-out group-hover:shadow-md group-hover:border-emerald-400/50 dark:shadow dark:group-hover:shadow-lg",
        team_formation: "relative overflow-hidden bg-gradient-to-br from-indigo-400/10 to-indigo-500/5 text-indigo-500 border border-indigo-400/30 shadow-sm backdrop-blur-sm before:absolute before:inset-0 before:bg-gradient-to-b before:from-foreground/[0.02] before:to-transparent after:absolute after:inset-0 after:bg-gradient-to-t after:from-background/10 after:to-transparent transition-all duration-300 ease-in-out group-hover:shadow-md group-hover:border-indigo-400/50 dark:shadow dark:group-hover:shadow-lg",
      },
    },
    defaultVariants: {
      variant: "default",
