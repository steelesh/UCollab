    ...
    <div className="flex flex-col items-center px-6 py-12">
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          🌿
          {" "}
          <strong>Step 1: Fork & Clone the Repository</strong>
        </h2>
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          🔃
          {" "}
          <strong>Step 2: Create a New Branch</strong>
        </h2>
        <p className="text-secondary mt-2 text-sm">
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          🛠
          {" "}
          <strong>Step 3: Make Your Changes</strong>
        </h2>
        <p className="text-secondary mt-2 text-sm">
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          📥
          {" "}
          <strong>Step 4: Commit & Push</strong>
        </h2>
        <p className="text-secondary mt-2 text-sm">
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          ✅
          {" "}
          <strong>Step 5: Open a Pull Request</strong>
        </h2>
        <p className="text-secondary mt-2 text-sm">
          Open a
          {" "}
        ...
        <p className="text-secondary mt-2 text-sm">
          <a href="https://github.com/steelesh/UCollab/pulls" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">
      ...
      <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
        <h2 className="text-lg font-semibold">
          📜
          <strong>Contribution Best Practices</strong>
        </h2>
        <ul className="text-secondary-foreground mt-4 space-y-2 pl-5">
          <li>
            ✅
            {" "}
            <strong>Write clean, well-structured code.</strong>
          </li>
          <li>
            ✅
            {" "}
            <strong>Use meaningful commit messages.</strong>
          </li>
          <li>
            ✅
            {" "}
            <strong>Ensure your changes do not break existing functionality.</strong>
          </li>
          <li>
            ✅
            {" "}
            <strong>Follow the</strong>
            {" "}
            <a href="/c/code-of-conduct" className="text-blue-400 underline">Code of Conduct</a>
            .
          </li>
        </ul>
      </div>
