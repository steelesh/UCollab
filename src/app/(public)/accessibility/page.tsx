      ...
      <div className="card bg-base-300 mt-10 p-8 shadow-2xl">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            as possible. We have ensured that our different color modes invert the colors seamlessly to provide a 
            comfortable viewing experience. 
          </li>
          <li>
            <strong>Mobile Accessibility:</strong> The UCollab website is compatibile with mobile devices, allowing those
            with limited computer access to be able to collaborate and contribute with ease. 
          </li>
          <li>
            <strong>Text-to-Speech:</strong> Using Web Accessibility Initiative – Accessible Rich Internet Application attributes, 
            we are able to provide users the ability to use the text-to-speech function. This allows a person to have text read out 
