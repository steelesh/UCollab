      ...
      <div className="flex flex-col items-center px-6 py-12">
        ...
        <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
          ...
          <p className="text-secondary mt-2 text-sm">
            ...
            <a href="/projects" className="text-blue-400 underline">Projects Page</a> to see what’s available.
          </p>
        </div>
        ...
        <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
          ...
          <p className="text-secondary mt-2 text-sm">
            Read our <a href="/c/community-guide" className="text-blue-400 underline">Community Guide</a> for best practices.
          </p>
        </div>
        ...
        <div className="relative mt-8 w-full max-w-3xl rounded-lg shadow-2xl px-6 py-6">
          ...
          <p className="text-secondary mt-2 text-sm">
            ...
            <a href="/c/contribution-guide" className="text-blue-400 underline">Contribution Guide</a> for guidelines on submitting code, reporting issues, and reviewing pull requests.
          </p>
        </div>
