...
export function InteractiveHoverButton({ ref, children, className, ...props }: InteractiveHoverButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
  return (
    <button
      type="button"
      ref={ref}
    ...
    >
      <div className="flex items-center gap-2">
        <div className="bg-uc-red h-2 w-2 rounded-full transition-all duration-300 group-hover:scale-[100.8]"></div>
