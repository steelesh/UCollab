...
const routes: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/p/feedback?sortBy=createdDate&sortOrder=desc&limit=8&page=1" as Route,
        description: "Projects seeking community feedback",
        requiresAuth: true,
      },
      {
        title: "Project Collaboration",
        href: "/p/collabs?sortBy=createdDate&sortOrder=desc&limit=8&page=1&postNeeds=CONTRIBUTION" as Route,
        description: "Projects and developers seeking collaboration",
        requiresAuth: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/p/teams?sortBy=createdDate&sortOrder=desc&limit=8&page=1" as Route,
        description: "Team building opportunities and posts",
        requiresAuth: true,
      },
      {
        title: "Mentorship",
        href: "/m?sortBy=createdDate&sortOrder=desc&limit=8&page=1&postNeeds=MENTOR_AVAILABLE" as Route,
        description: "Mentorship connections and opportunities",
        requiresAuth: true,
      },
      {
    ...
    items: [
      {
        ...
        href: "/r/getting-started" as Route,
        description: "Platform introduction and onboarding",
        requiresAuth: false,
      },
      {
        title: "Community Guide",
        href: "/r/community-guide" as Route,
        description: "How to get the most out of UCollab",
        requiresAuth: false,
      },
      {
        title: "Contribution Guide",
        href: "/r/contribution-guide" as Route,
        description: "How to contribute to UCollab",
        requiresAuth: false,
      },
      {
        title: "Code of Conduct",
        href: "/r/code-of-conduct" as Route,
