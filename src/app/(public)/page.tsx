...
const SLIDES = [
  <div>
    ...
    <img src="/collab.svg" alt="Connect with Peers" className="w-3/4 py-6" />
  </div>,
  <div>
    <img src="/ideas.svg" alt="Discover Projects" className="w-1/2" />
  ...
  <div>
    ...
    <img src="/project.svg" alt="Innovate through Collaboration" className="w-1/2 py-2" />
  </div>,
];
